...
Astrofolio uses a custom [image grid component](https://github.com/vikas5914/Astrofolio/blob/main/src/components/mdx/ImageGrid.astro) to display image galleries with lightbox functionality. Click any image to view it in full screen.

**Note**: The photos page now uses Sanity CMS for dynamic photo management with automatic image optimization, WebP conversion, and responsive sizing. The component supports both static files and Sanity images.

```jsx
<ImageGrid
  columns={3} // Accepts 2, 3, or 4 columns
  images={[
    { src: "/photos/photo1.jpg", alt: "Photo1", caption: "Beautiful Photo 1" },
    { src: "/photos/photo2.jpg", alt: "Photo2", caption: "Amazing Photo 2" },
    { src: "/photos/photo3.jpg", alt: "Photo3" }, // caption is optional
  ]}
/>
```
